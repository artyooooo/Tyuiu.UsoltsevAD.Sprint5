...
namespace Tyuiu.UsoltsevAD.Sprint5.Task4.V3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* файла и подставить вместо X в формуле: y = (sin(x)+4)/x) - 1.25x        *");
            Console.WriteLine("* Округлить до трёх знаков после запятой.                                 *");
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* ИСХОДНЫЕ ДАННЫЕ:                                                        *");
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("y = (sin(x)+4)/x) - 1.25x");
